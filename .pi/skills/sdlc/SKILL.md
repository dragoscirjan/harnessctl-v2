---
name: sdlc
description: Epic-first Plan, Build, Verify, Release, and Continue workflow with progressive disclosure.
---

# Compact SDLC

Load one phase reference only:
...
- Work under exactly one authoritative, non-archived Epic. Resolve a child through parents. Plan may create an Epic or Initiative with Epics; other phases redirect missing ownership to Plan.
